...
<div class="code_div">
	<pre>
<?php
	echo str_replace("\t", "&nbsp;&nbsp;", htmlspecialchars(file_get_contents("papers/note/susliks/35susliks/resources/case01/test.html")));
?>
	</pre>
	<a class="try_button" href="papers/note/susliks/35susliks/resources/case01/test.html" target="_blank">check the result</a>
