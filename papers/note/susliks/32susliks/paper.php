...
<div class="code_div">
	<pre>
<?php
	echo str_replace("\t", "&nbsp;&nbsp;", htmlspecialchars(file_get_contents("papers/note/susliks/32susliks/resources/case01/index.html")));
?>
	</pre>
	<a class="try_button" href="papers/note/susliks/32susliks/resources/case01/index.html" target="_blank">check the result</a>
...
<div class="code_div">
	<pre>
<?php
	echo str_replace("\t", "&nbsp;&nbsp;", htmlspecialchars(file_get_contents("papers/note/susliks/32susliks/resources/case02/index.html")));
?>
	</pre>
	<a class="try_button" href="papers/note/susliks/32susliks/resources/case02/index.html" target="_blank">check the result</a>
	<div class="G-Clear"></div>
</div>
<p>css：</p>
<div class="code_div">
...
<div class="code_div">
	<pre>
<?php
	echo str_replace("\t", "&nbsp;&nbsp;", htmlspecialchars(file_get_contents("papers/note/susliks/32susliks/resources/case03/index.html")));
?>
	</pre>
	<a class="try_button" href="papers/note/susliks/32susliks/resources/case03/index.html" target="_blank">check the result</a>
	<div class="G-Clear"></div>
</div>
<p>css：</p>
<div class="code_div">
