...
<div class="code_div">
	<pre>
<?php
	echo htmlspecialchars(file_get_contents("papers/note/html/02html/resources/case01.html"));
?>
	</pre>
...
<div class="code_div">
	<pre>
<?php
	echo htmlspecialchars(file_get_contents("papers/note/html/02html/resources/case02.html"));
?>
	</pre>
...
<div class="code_div">
	<pre>
<?php
	echo htmlspecialchars(file_get_contents("papers/note/html/02html/resources/case03.html"));
?>
	</pre>
...
<div class="code_div">
	<pre>
<?php
	echo htmlspecialchars(file_get_contents("papers/note/html/02html/resources/case04.html"));
?>
	</pre>
