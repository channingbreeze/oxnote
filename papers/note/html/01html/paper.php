...
<div class="code_div">
	<pre>
<?php
	echo str_replace("\t", "&nbsp;&nbsp;&nbsp;&nbsp;", htmlspecialchars(file_get_contents("papers/note/html/01html/resources/case01.html")));
?>
	</pre>
...
<div class="code_div">
	<pre>
<?php
	echo str_replace("\t", "&nbsp;&nbsp;", htmlspecialchars(file_get_contents("papers/note/html/01html/resources/case02.html")));
?>
	</pre>
